        ...
        <div class="mobile-nav">
          <div class="mobile-container">
           ...
           <div id="myLinks" class="myLinks">
             <a href="services.html"><i class="fas fa-grip-vertical"></i><span>خدماتنا</span></a>
             <a href="baqat.html"><i class="fas fa-clone"></i><span>الباقات</span></a>
             ...
             <a href="https://twitter.com/_anonz1"><i class="fab fa-twitter"></i></a>
             <a href="https://www.snapchat.com/add/golden_chart"><i class="fab fa-snapchat-ghost"></i></a>
        ...
        <div class="reg-form">
          <div class="container">
            ...
            <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
              ...
              <input type="email" name="email" value="البريد الإلكتروني*" onfocus="if(this.value==this.defaultValue)this.value=''"
              onblur="if(this.value=='')this.value=this.defaultValue">
